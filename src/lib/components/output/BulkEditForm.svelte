Bu svelte componente İngilizce metinleri Türkçeye çevirin: <script lang="ts">
  ...
  const OPERATIONS = [{ id: "rename_account", label: "Hesabı Yeniden Adlandır" }];
